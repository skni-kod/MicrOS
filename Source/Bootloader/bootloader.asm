...
;
; |------------|---------|------------|----------------|------------|------------|---------|---------|------------|------------|------------|------------|
; |   1 KiB    |  256 B  |   22 KiB   |     4 KiB      |   512 B    |   28 KiB   | 578 KiB |  1 KiB  |  383 KiB   |   15 MiB   |   1 MiB    |   4 MiB    |
; | Interrupts |   BDA   | Floppy DMA | Page Directory | Bootloader | FAT32 data |  Kernel |  EBDA   | Video, ROM |  Reserved  |   Stack    | Page Table |
; |            |         |            |                |            |            |         |         |            |            |            |            |
; |  0x00000   | 0x00400 |  0x00500   |    0x05000     |  0x07C00   |  0x07E00   | 0x0F000 | 0x9FC00 |  0xA0000   | 0x00100000 | 0x01000000 | 0x01100000 |
; |  0x003FF   | 0x004FF |  0x05BFF   |    0x05FFF     |  0x07DFF   |  0x0EFFF   | 0x9FBDD | 0x9FFFF |  0xFFFFF   | 0x00FFFFFF | 0x010FFFFF | 0x014FFFFF |
; |------------|---------|------------|----------------|------------|------------|---------|---------|------------|------------|------------|------------|
