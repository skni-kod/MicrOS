...
// void ethernet_process_data(nic_data_t *data)
// {
//     ethernet_frame_t frame = *(ethernet_frame_t *)data->packet;
//     frame.type = __uint16_flip(frame.type);
//     // last is offset of data ptr;
//     void *data_ptr = data->packet + sizeof(ethernet_frame_t) - sizeof(uint8_t *);

//     switch (frame.type)
//     {
//     case ARP_PROTOCOL_TYPE:
//         arp_process_packet((arp_packet_t *)data_ptr, data->device->mac_address);
//         break;
