...
#define harddisk_io_data_register 0
...
Direction: read
Param. size for LBA48: 8 bit*/
#define harddisk_control_alterante_status_register 0
...
Direction: write
Param. size for LBA48: 8 bit*/
#define harddisk_control_device_control_register 0
...
Direction: read
Param. size for LBA48: 8 bit*/
#define harddisk_control_drive_adderss_register 1
...
typedef struct harddisk_io_error_register
{
...
typedef struct harddisk_io_drive_head_register
{
...
typedef struct harddisk_io_control_status_register
{
...
typedef struct harddisk_control_device_control_register
{
    //! Always set to zero.
