...
screen_char *mode01h_buffer = NULL;
uint16_t mode01h_buffer_cursor_x = 0;
uint16_t mode01h_buffer_cursor_y = 0;
...
int8_t mode01h_set_mode()
{
	...
	vga_clear_screen();
	vga_color col;
	col.color_without_blink.letter = VGA_MODE_01H_COLOR_WHITE;
	...
	video_card_set_print_char_func(mode01h_print_char);
	video_card_set_print_char_color_func(mode01h_print_char_color);
	video_card_set_print_string_func(mode01h_print_string);
	video_card_set_print_string_color_func(mode01h_print_string_color);
	video_card_set_set_char_func(mode01h_set_char);
	video_card_set_get_char_func(mode01h_get_char);
	video_card_set_set_color_func(mode01h_set_color);
	video_card_set_get_color_func(mode01h_get_color);
	video_card_set_set_char_and_color_func(mode01h_set_char_and_color);
	video_card_set_get_char_and_color_func(mode01h_get_char_and_color);
	video_card_set_set_cursor_pos_func(mode01h_set_cursor_pos);
	video_card_set_get_cursor_pos_func(mode01h_get_cursor_pos);
	video_card_set_turn_cursor_on_func(mode01h_turn_cursor_on);
	video_card_set_turn_cursor_off_func(mode01h_turn_cursor_off);
	...
	video_card_set_print_char_external_buffer(mode01h_print_char_external_buffer);
	video_card_set_print_char_color_external_buffer(mode01h_print_char_color_external_buffer);
	video_card_set_print_string_external_buffer(mode01h_print_string_external_buffer);
	video_card_set_print_string_color_external_buffer(mode01h_print_string_color_external_buffer);
	video_card_set_set_char_external_buffer(mode01h_set_char_external_buffer);
	video_card_set_get_char_external_buffer(mode01h_get_char_external_buffer);
	video_card_set_set_color_external_buffer(mode01h_set_color_external_buffer);
	video_card_set_get_color_external_buffer(mode01h_get_color_external_buffer);
	video_card_set_set_char_and_color_external_buffer(mode01h_set_char_and_color_external_buffer);
	video_card_set_get_char_and_color_external_buffer(mode01h_get_char_and_color_external_buffer);
    return 0x01;
}
...
int8_t mode01h_turn_on_buffer()
{
    ...
    mode01h_buffer = heap_kernel_alloc(MODE01H_HEIGHT * MODE01H_WIDTH * sizeof(screen_char), 0);
    if(mode01h_buffer == NULL)
        return -1;
	video_card_set_print_char_func(mode01h_print_char_buffered);
	video_card_set_print_char_color_func(mode01h_print_char_color_buffered);
	video_card_set_print_string_func(mode01h_print_string_buffered);
	video_card_set_print_string_color_func(mode01h_print_string_color_buffered);
	video_card_set_set_char_func(mode01h_set_char_buffered);
	video_card_set_get_char_func(mode01h_get_char_buffered);
	video_card_set_set_color_func(mode01h_set_color_buffered);
	video_card_set_get_color_func(mode01h_get_color_buffered);
	video_card_set_set_char_and_color_func(mode01h_set_char_and_color_buffered);
	video_card_set_get_char_and_color_func(mode01h_get_char_and_color_buffered);
	video_card_set_set_cursor_pos_func(mode01h_set_cursor_pos_buffered);
	video_card_set_get_cursor_pos_func(mode01h_get_cursor_pos_buffered);
...
int8_t mode01h_print_char_buffered(char character)
{
	...
	{
		__mode01h_print_char_buffer((uint16_t*)mode01h_buffer, 0, &mode01h_buffer_cursor_x, &mode01h_buffer_cursor_y, character);
		return 0;
	}
}
...
int8_t mode01h_print_char_color_buffered(char character, uint8_t color)
{
	...
	{
		__mode01h_print_char_color_buffer((uint16_t*)mode01h_buffer, 0, &mode01h_buffer_cursor_x, &mode01h_buffer_cursor_y, character, color);
		return 0;
	}
}
...
int8_t mode01h_print_string_buffered(const char* string)
{
	...
	{
		__mode01h_print_string_buffer((uint16_t*)mode01h_buffer, 0, &mode01h_buffer_cursor_x, &mode01h_buffer_cursor_y, string);
		return 0;
	}
}
...
int8_t mode01h_print_string_color_buffered(const char* string, uint8_t color)
{
	...
	{
		__mode01h_print_string_color_buffer((uint16_t*)mode01h_buffer, 0, &mode01h_buffer_cursor_x, &mode01h_buffer_cursor_y, string, color);
		return 0;
	}
}
int8_t mode01h_set_char_buffered(uint16_t x, uint16_t y, char character)
{
	...
	{
		__mode01h_set_char_buffer((uint16_t*)mode01h_buffer, 0, mode01h_buffer_cursor_x, mode01h_buffer_cursor_y, character);
		return 0;
	}
}
...
int8_t mode01h_get_char_buffered(uint16_t x, uint16_t y, char* character)
{
	...
	{
		__mode01h_get_char_buffer((uint16_t*)mode01h_buffer, 0, mode01h_buffer_cursor_x, mode01h_buffer_cursor_y, character);
		return 0;
	}
}
...
int8_t mode01h_set_color_buffered(uint16_t x, uint16_t y, uint8_t color)
{
	...
	{
		__mode01h_set_color_buffer((uint16_t*)mode01h_buffer, 0, mode01h_buffer_cursor_x, mode01h_buffer_cursor_y, color);
		return 0;
	}
}
...
int8_t mode01h_get_color_buffered(uint16_t x, uint16_t y, uint8_t* color)
{
	...
	{
		__mode01h_get_color_buffer((uint16_t*)mode01h_buffer, 0, mode01h_buffer_cursor_x, mode01h_buffer_cursor_y, color);
		return 0;
	}
}
...
int8_t mode01h_set_char_and_color_buffered(uint16_t x, uint16_t y, char character, uint8_t color)
{
	...
	{
		__mode01h_set_char_and_color_buffer((uint16_t*)mode01h_buffer, 0, mode01h_buffer_cursor_x, mode01h_buffer_cursor_y, character, color);
		return 0;
	}
}
...
int8_t mode01h_get_char_and_color_buffered(uint16_t x, uint16_t y, char* character, uint8_t* color)
{
	...
	{
		__mode01h_get_char_and_color_buffer((uint16_t*)mode01h_buffer, 0, mode01h_buffer_cursor_x, mode01h_buffer_cursor_y, character, color);
		return 0;
	}
}
...
int8_t mode01h_set_cursor_pos_buffered(uint16_t x, uint16_t y)
{
	...
	{
		mode01h_buffer_cursor_x = x;
		mode01h_buffer_cursor_y = y;
		return 0;
	}
}
...
int8_t mode01h_get_cursor_pos_buffered(uint16_t* x, uint16_t* y)
{
	...
	{
		*x = mode01h_buffer_cursor_x;
		*y = mode01h_buffer_cursor_y;
		return 0;
	}
}
...
{
	return __mode01h_print_char_buffer((uint16_t*)buffer, mode, x, y, character);
}
...
{
	return __mode01h_print_char_color_buffer((uint16_t*)buffer, mode, x, y, character, color);
}

int8_t mode01h_print_string_external_buffer(uint8_t* buffer, uint16_t mode, uint16_t* x, uint16_t* y, const char* string)
{
	return __mode01h_print_string_buffer((uint16_t*)buffer, mode, x, y, string);
}
...
{
	return __mode01h_set_char_and_color_buffer((uint16_t*)buffer, mode, x, y, character, color);
}
...
{
	return __mode01h_get_char_and_color_buffer((uint16_t*)buffer, mode, x, y, character, color);
}
...
int8_t mode01h_draw_line_external_buffer(uint8_t* buffer, uint16_t mode, uint8_t color, uint16_t ax, uint16_t ay, uint16_t bx, uint16_t by)
{
    ...
    if(_abs(dx) >= _abs(dy))
    {
        ...
        if(ax > bx)
            for(int x = bx; x <= ax; ++x)
                mode01h_draw_pixel_external_buffer(buffer, mode, color, x, a * x + b);
        else
            for(int x = ax; x <= bx; ++x)
                mode01h_draw_pixel_external_buffer(buffer, mode, color, x, a * x + b);
    }
    else
    {
        ...
        if(ay > by)
            for(int y = by; y <= ay; ++ y)
                mode01h_draw_pixel_external_buffer(buffer, mode, color, a * y + b, y);
        else
            for(int y = ay; y <= by; ++ y)
                mode01h_draw_pixel_external_buffer(buffer, mode, color, a * y + b, y);
    }
...
int8_t mode01h_swap_external_buffer(uint8_t* buffer, uint16_t mode){
    memcpy((screen_char*)VGA_MODE_01H_BASE_ADDR, (screen_char*)buffer, MODE01H_HEIGHT * MODE01H_WIDTH * sizeof(screen_char));
    return 0;
}
uint8_t* mode01h_create_external_buffer(uint16_t mode){
	return heap_kernel_alloc(MODE01H_HEIGHT * MODE01H_WIDTH * sizeof(screen_char), 0);
}

int8_t __mode01h_print_char_buffer(uint16_t* buffer, uint16_t mode, uint16_t* x, uint16_t* y, char character)
{
    __mode01h_print_char_color_buffer(buffer, mode, x, y, character, 0);
}
...
int8_t __mode01h_print_string_buffer(uint16_t* buffer, uint16_t mode, uint16_t* x, uint16_t* y, const char* string)
{
    ...
    while (*ptr != 0)
    {
        __mode01h_print_char_buffer(buffer, mode, x, y, *ptr);
        ptr++;
    }
}
...
int8_t __mode01h_print_string_color_buffer(uint16_t* buffer, uint16_t mode, uint16_t* x, uint16_t* y, const char* string, uint8_t color)
{
    ...
    while (*ptr != 0)
    {
        __mode01h_print_char_color_buffer(buffer, mode, x, y, *ptr, color);
        ptr++;
    }
}
...
void __mode01h_newline(uint16_t* buffer, uint16_t* x, uint16_t* y)
{
    ...
    *y++;
    ...
    if (*y == MODE01H_HEIGHT)
    {
        ...
        for (uint16_t i = 0; i < MODE01H_HEIGHT - 1; ++i)
        {
            for (uint16_t j = 0; j < MODE01H_WIDTH; ++j)
            {
                uint16_t pos = __mode01h_calcualte_position(j, i);
                // Copy byte from next line
                buffer[pos] = buffer[pos + MODE01H_WIDTH];
            }
        }
        *y = MODE01H_HEIGHT - 1;
        ...
        // Clear last line
		vga_color_value col;
        col.color = __vga_get_default_terminal_color(VGA_MODE_01H);
        for (uint16_t i = 0; i < MODE01H_WIDTH; ++i)
        {
            uint16_t pos = __mode01h_calcualte_position(i, *y);
            // Clear
