...
int8_t mode00h_swap_buffers()
{
	...
	__vga_update_cursor(mode00h_buffer_cursor_x, mode00h_buffer_cursor_y);
    return 0;
}
...
{
    __mode00h_print_char_color_buffer(buffer, mode, x, y, character, 0);
	return 0;
}
	...
	*x = 0;
    ...
    if (*y == MODE00H_HEIGHT)
    {
        ...
        *y = MODE00H_HEIGHT - 1;
        ...
        // Clear last line
		vga_color_value col;
        col.color = __vga_get_default_terminal_color(VGA_MODE_00H);
