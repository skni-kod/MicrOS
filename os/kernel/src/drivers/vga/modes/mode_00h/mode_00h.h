...
/*!
    ...
    \param mode Mode.
    \param x X coordinate of screen cursor also returns new position of coordinate.
    \param y Y coordinate of screen cursor also returns new position of coordinate.
    \param character Character.
    \return 0 if success, -1 if not implemented.
*/
...
//! Helper function to set character and character color on given point on screen for mode 00h on given buffer.
/*!
...
//! Helper function to get character and character color color from given point on screen for mode 00h on given buffer.
/*!
